...
def do_auth_capture(amount='0.00', card_num=None, exp_date=None, card_cvv=None,bill_name=None,bill_address=None,bill_city=None, bill_state=None,bill_zip=None,bill_country=None):
    delimiter = '|'
    raw_params = {
